...
exports.MudarProntidao = (socket, codigo)=>{
    ...
    Jogador.estado = (Jogador.estado === "PRONTO") ? "NÃO PRONTO" : "PRONTO" // Da um toggle no estado do jogador

    const SalaPronta = Sala.jogadores.every(jogador => jogador.estado.toUpperCase() === "PRONTO")
    if(SalaPronta){
